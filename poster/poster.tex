...
% Left: institution
 \logoright{\includegraphics[height=9cm]{logos/uhm-logo-huge.png}}
...
\begin{column}{\colwidth}
  ...
  \begin{block}{Example Results}
    ...
    \begin{figure}
      \centering
        \includegraphics[width=0.65\textwidth]{figures/fix-test2.png}
  ...
  \begin{alertblock}{The Bertrand Model}
    ...
    We will consider an example that was created into a systems of polynomial equations below, where $Z$ was constructed as a trick
    to avoid a rational expression. $f_1$ and $f_2$ were constructed using equations that are omitted from this poster.
    ...
    Here, we also use a total degree homotopy, where the solutions are the unitary roots. 
    We use Bézout's Theorem to see that there should be an upper bound of 600 solutions/paths. 
...
\begin{column}{\colwidth}
  ...
  \begin{block}{Results of Bertrand Model with Homotopy Continuation}
    ...
    Narrowing it down to non-singular solutions we get 62, 18 real. But there are only 4 relevant solutions.
  \begin{table}[h]
      \centering
